...
public class US1StepsDefinition {
    ...
    public void a_bank_account_with_a_balance_of_€_the(int accountBalance, String date) throws Throwable {
    ...
    public void the_customer_s_bank_account_balance_is_€(int accountBalance) throws Throwable {
